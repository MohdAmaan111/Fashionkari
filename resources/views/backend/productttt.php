                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          $imageArray = $firstVariant ? json_decode($firstVariant->images, true) : [];
        ...
        <form action="{{ route('admin.product.store') }}" id="productForm" method="POST" enctype="multipart/form-data">
          ...
          <div class="modal-body">
            ...
            <div class="row g-3">
              ...
              <!-- Toggle for Color & Images -->
              <div class="col-md-12 mt-2">
                <button class="btn btn-outline-dark w-100" type="button" data-bs-toggle="collapse" data-bs-target="#colorImageSection" aria-expanded="false" aria-controls="colorImageSection">
                  <i class="bi bi-palette2 me-1"></i> Add Color & Images
                </button>
              </div>

              <!-- Toggle for Meta Information -->
              <div class="col-md-12 mt-2">
              ...
              <!-- Collapsible Color & Image Section -->
              <div class="collapse mt-3" id="colorImageSection">
                <div class="card card-body border rounded shadow-sm">
                  <div class="row g-3">
                    ...
                    <div class="col-md-12">
                      ...
                      <small class="d-block text-muted mb-2">You can upload up to 3 images</small>
            ...
            <div class="modal-body">
              ...
              <div class="mb-3">
                ...
                <div class="d-flex gap-3 flex-wrap">
                  ...
                  <!-- Image 4 -->
                  <div>
                    <div class="image-preview" id="imagePreviewBox4_{{ $product->prod_id }}">
                      <div class="img-holder text-center">
                        <i class="bi bi-image" style="font-size: 2rem;"></i><br>
                        <small>Click to select</small>
                      </div>
                    </div>
                    <input type="file" name="images[]" id="imageInput4_{{ $product->prod_id }}" accept="image/*" style="display: none;">
                  </div>
                </div>
...
<script>
  ...
  $(document).ready(function() {
    ...
    // Bind for type 4
    $("[id^=imagePreviewBox4_]").each(function() {
      const previewId = $(this).attr("id");
      const suffix = previewId.split("_")[1];
      bindImagePreview(previewId, `imageInput4_${suffix}`);
    });
